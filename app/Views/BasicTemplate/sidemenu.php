                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <!-- ============================= Admin Page ======================================== -->
                            <li>
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-email"></i><span> Admin Page <span class="float-right menu-arrow"><i class="mdi mdi-plus"></i></span> </span></a>
                                <ul class="submenu">
                                    <li><a href="<?= site_url() ?>Adminpage/joblist">Job List</a></li>
                                    <li><a href="<?= site_url() ?>Adminpage/appliedList">Applied Person List</a></li>
                                    <!-- <li><a href="<?= site_url() ?>Adminpage/">Job-Description Change</a></li> -->
                                    <li><a href="<?= site_url() ?>Adminpage/jobDesc">Job-Description</a></li>
